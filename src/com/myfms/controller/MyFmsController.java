...
public class MyFmsController {
	...
	public String showForm(Model model) {
		...
		/*model.addAttribute("householdclicked", true);*/
		return "home";
	...
	public String processSurvey(@ModelAttribute("Fms") MyFms thefms, Model model) {
		...
		model.addAttribute("householdclickedSearch", true);
	...
	public String SurveyProcess(@ModelAttribute("Fms1") MyService theservice, Model model) {
		...
		model.addAttribute("store50",myservice);
		 ...
		 model.addAttribute("serviceclickedSearch", true);
	...
	public String ProcessAdmin(@ModelAttribute("store90") MyAdmin theadmin, Model model) {
		...
		MyAdmin myadmin= new MyAdmin();
		model.addAttribute("store90",myadmin);
		/*model.addAttribute("adminSearch", true);*/
		
		model.addAttribute("msg","Data Saved Successfully");
		model.addAttribute("adminclickedSearch", true);
	...
	@RequestMapping("/myownsearchess")
	public String myownsearchess(@RequestParam("fromDateOfVisit") String myownvisit,@RequestParam ("toDateOfVisit") String myownvisit1, Model model) throws ParseException {
		System.out.println("MyID IS----------------------<" +myownvisit+"uuuuuuuuuuuuuu"+myownvisit1);//Printing the id
		...
		List<MyAdmin> myownfms=myfmsservice.myowncollect(mySqlDate1,mySqlDate2);
	     model.addAttribute("store49",myownfms);
	     MyAdmin myadmin= new MyAdmin();
		model.addAttribute("store90",myadmin);
		model.addAttribute("adminclickedSearch", true);
